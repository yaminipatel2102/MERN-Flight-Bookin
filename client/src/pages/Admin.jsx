...
const Admin = () => {
  ...
  const fetchData = async () =>{
    await axios.get('/api/fetch-users').then(
      (response)=>{
    ...
    await axios.get('/api/fetch-bookings').then(
      (response)=>{
        setbookingCount(response.data.length);
      }
    );
    await axios.get('/api/fetch-flights').then(
      (response)=>{
  ...
  const approveRequest = async (id) =>{
      try{
          ...
          await axios.post('/api/approve-operator', {id}).then(
            (response)=>{
  ...
  const rejectRequest = async (id) =>{
    try{
      ...
      await axios.post('/api/reject-operator', {id}).then(
        (response)=>{
